...
const domain = new Domain({
  awsLakeFormation, awsSts, logger, lakeRoleSessionName: DATA_LAKE_ADMIN_ROLE_SESSION_NAME, accountId: ACCOUNT_ID
});
const handler = new Handler(domain, logger);

export const assignVisibilityFileLFTagsHandler =
