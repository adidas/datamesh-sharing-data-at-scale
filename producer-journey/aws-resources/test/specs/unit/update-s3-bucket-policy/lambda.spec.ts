...
import {
  UpdateS3BucketPolicyLambda, UpdateS3BucketPolicyLambdaProps
...
const lambdaId = 'UpdateS3BucketPolicyProducer';
...
describe('# UpdateS3BucketPolicyLambda Construct', () => {
  ...
  it('Should create a new lambda successfully', (done) => {
    ...
    expect(Code.fromAsset).toHaveBeenCalledWith(
      './producer-journey/update-s3-bucket-policy-lambda/dist'
    );
